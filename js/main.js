            ...
            handler: function(direction) {
                ...
                if (direction === "down") {
                    ...
                    stats.each(function () {
                        ...
                        var isActiveClients = $this.is("#active-clients");
                        var isActiveExperts = $this.is("#active-experts");
                        var isActiveYears =  $this.is("#active-years");
                        ...
                        $({ Counter: 0 }).animate({ Counter: $this.text() }, {
                            ...
                            step: function (curValue) {
                                if (isActiveClients || isActiveExperts || isActiveYears) {
